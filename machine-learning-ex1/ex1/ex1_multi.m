...
% not need to be normalized. (Garry: but the remaining columns
% sure *do* need to be normalized using the same mu and sigma
...
% ====================== YOUR CODE HERE ======================
price = 0; % You should change this
price = [ones(1, 1) ([1650, 3] .- mu) ./ sigma] * theta; % gmbroth: remember, normal equation doesn't use feature normalization!
